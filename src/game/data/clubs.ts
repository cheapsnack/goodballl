...
export const CLUBS: Club[] = [
  ...
  {
    id: "lilywhite-athletic",
    name: "Lilywhite Athletic",
    shortName: "LWA",
    primaryColor: "#132257",
    secondaryColor: "#FFFFFF",
    formation: "4-4-2",
...
export const DEFAULT_HOME_CLUB_ID = "meridian-city";
export const DEFAULT_AWAY_CLUB_ID = "redbrook-united";
